...
function OrderList({ handleDetailsVisibility }) { // Destructure props correctly
  return (
    <button
      onClick={handleDetailsVisibility} // Directly use the prop
    ...
    >
      ...
      <p className="text-sm font-light">2 items for ₹180</p>
    </button>
  );
}
