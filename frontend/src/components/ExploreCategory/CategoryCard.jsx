...
function CategoryCard({ imgSrc, text }) {
  return (
    <div className="h-[180px] w-[100px] md:h-[250px] md:w-[200px] bg-secondary shadow-md rounded-lg cursor-pointer transition hover:scale-105">
